...
const { signupLogin } = require('../templates/forms.js');

const { html, navBar } = require('..html'); //if causes an error revert to original file structure 
...
function getSignin(request, response) {
    ...
    const content = signupLogin('/sign-in');
